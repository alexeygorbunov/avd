...
def _get_digital_twin(fabric_documentation_facts: FabricDocumentationFacts) -> dict:
    ...
    for digital_twin_node_type in digital_twin_node_types:
    ...
    if device_list:
        match next(iter(digital_twin_environment)):
            case "act":
                # Render nodes
