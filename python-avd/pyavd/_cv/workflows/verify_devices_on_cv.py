...
async def verify_devices_in_cloudvision_inventory(
    *,
    ...
    device_tuples = {
        (device.intended_serial_number, device.intended_system_mac_address, device.hostname if not any(
            [device.intended_serial_number, device.intended_system_mac_address]
        ) else None)
