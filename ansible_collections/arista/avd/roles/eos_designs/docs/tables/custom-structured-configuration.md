...
=== "Table"
    ...
    | [<samp>digital_twin_custom_structured_configuration_prefix</samp>](## "digital_twin_custom_structured_configuration_prefix") | List, items: String |  | See (+) on YAML tab |  | Custom EOS Structured Configuration keys that will only be applied to the fabric nodes in the Digital Twin mode.<br> |
...
=== "YAML"
    ...
    # Custom EOS Structured Configuration keys that will only be applied to the fabric nodes in the Digital Twin mode.
