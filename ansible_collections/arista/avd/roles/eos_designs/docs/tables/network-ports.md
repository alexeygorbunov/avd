...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;digital_twin</samp>](## "network_ports.[].digital_twin") | Boolean |  | `True` |  | Setting this flag to `false` will exclude associated network ports from the generated Digital Twin topology. |
...
=== "YAML"
    ...
    network_ports:
      ...
      - switches:
        ...
        # Setting this flag to `false` will exclude associated network ports from the generated Digital Twin topology.
